...
namespace HMS_FORMS
{
    public partial class RcustUC : UserControl
    {
        public RcustUC()
        {
            InitializeComponent();
        ...
        private void RcustUC_Load(object sender, EventArgs e)
        {
        ...
        private void Insertrbtn_CheckedChanged_1(object sender, EventArgs e)
        {
            groupBox1.Visible = true;
        }

        private void Viewrbtn_CheckedChanged_1(object sender, EventArgs e)
        {
            dataGridView1.Visible = true;
        ...
        private void Searchrbtn_CheckedChanged_1(object sender, EventArgs e)
        {
            dataGridView1.Visible = true;
            groupBox1.Hide();
        }
